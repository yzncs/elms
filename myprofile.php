...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">تحديث بيانات الموظف</div>
                    </div>
...
<label for="empcode">تسلسل الموظف</label>
...
<div class="input-field col s12">
<button type="submit" name="update"  id="update" class="waves-effect waves-light btn indigo m-b-xs">تحديث</button>
