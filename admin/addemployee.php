...
{
$error="هناك خطا الرجاء حاول مرة اخرى";
}
...
error:function (){}
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">اضافة موظف</div>
                    </div>
...
<label for="empcode">رقم الموظف</label>
...
<div class="input-field col s12">
<button type="submit" name="add" onclick="return valid();" id="add" class="waves-effect waves-light btn indigo m-b-xs">اضافة</button>
