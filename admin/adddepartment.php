...
{
$error="حدث خطأ الرجاء اعد المحاولة";
}
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">اضافة قسم جديد</div>
                    </div>
...
<input id="departmentshortname" type="text"  class="validate" autocomplete="off" name="departmentshortname"  required>
                                                <label for="deptshortname">الاسم المختصر للقسم</label>
                                            </div>
  <div class="input-field col s12">
 <input id="deptcode" type="text" name="deptcode" class="validate" autocomplete="off" required>
                                                <label for="password">الكود الخاص بلقسم</label>
                                            </div>
