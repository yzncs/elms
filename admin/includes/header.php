                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">نظام ادارة الاجازات</span>
                        </div>
...
$unreadcount=$query->rowCount();?>
                            ...
                            <li class="hide-on-med-and-up"><a href="javascript:void(0)" class="search-toggle"><i class="material-icons">بحث</i></a></li>
                        </ul>
                        
                        <ul id="dropdown1" class="dropdown-content notifications-dropdown">
                            <li class="notificatoins-dropdown-container">
                                <ul>
                                    <li class="notification-drop-title">لايوجد اي طلبات جديدة</li>
<?php 
$isread=0;
