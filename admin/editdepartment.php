  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">تحرير الاقسسام</div>
                    </div>
                            ...
                            <div class="card-content">
                                ...
                                <div class="row">
                                    <form class="col s12" name="chngpwd" method="post">
                                          <?php if($error){?><div class="errorWrap"><strong>هناك خطا</strong>:<?php echo htmlentities($error); ?> </div><?php } 
...
<input id="departmentshortname" type="text"  class="validate" autocomplete="off" value="<?php echo htmlentities($result->DepartmentShortName);?>" name="departmentshortname"  required>
 ...
 <input id="deptcode" type="text" name="deptcode" class="validate" autocomplete="off" value="<?php echo htmlentities($result->DepartmentCode);?>" required>
                                                <label for="password">كود القسم</label>
                                            </div>
...
<div class="input-field col s12">
<button type="submit" name="update" class="waves-effect waves-light btn indigo m-b-xs">القسم</button>
